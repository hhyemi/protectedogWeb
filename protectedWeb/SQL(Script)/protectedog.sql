...
CREATE TABLE REPORT (
	...
	REPORTER_NICK 		VARCHAR2(100) 	NOT NULL ENABLE,
	REPORTED_NICK 		VARCHAR2(100) 	NOT NULL ENABLE,
...
CREATE TABLE ADOPT(
   ...
   DOG_PAY       NUMBER(7,0)   NOT NULL ENABLE, 
...
CREATE TABLE MESSAGE (
	...
	SENDER_NICK 		VARCHAR2(100) 	NOT NULL ENABLE, 
	RECEIVER_NICK 		VARCHAR2(100) 	NOT NULL ENABLE, 
	SEND_DATE 		DATE, 
	RECEIVE_DATE 		DATE, 
...
CREATE TABLE BOARD (
	...
	ID 				VARCHAR2(12) 	NOT NULL ENABLE  REFERENCES USERS(ID), 
	NICKNAME 		VARCHAR2(14) 	NOT NULL ENABLE, 
	POST_TITLE 		VARCHAR2(150) 	NOT NULL ENABLE, 
...
VALUES 
(15555, 'IS', 'user01', '스캇', 'InfoShareTestTitle' ,  'InfoShareTestContent' , SYSDATE , 1000, 1000, '(37.56504944256021, 127.00464828401823)#(37.564573198150306, 126.99909074693937)#(37.56566175232779, 127.00385435014982)#');

INSERT INTO BOARD 
(post_no, board_code, id, nickname, post_title, post_content, reg_date, view_count, recommend_count, route)
VALUES 
(15556, 'IS', 'user02', '호랭이', 'InfoShareTestTitle1' ,  'InfoShareTestContent1' , SYSDATE , 1001, 1001, '(37.56504944256021, 127.00464828401823)#(37.564573198150306, 126.99909074693937)#(37.56566175232779, 127.00385435014982)#');

INSERT INTO BOARD 
(post_no, board_code, id, nickname, post_title, post_content, reg_date, view_count, recommend_count, route)
VALUES 
(15557, 'IS', 'user03' , '안녕', 'InfoShareTestTitle2' ,  'InfoShareTestContent2' , SYSDATE , 1002, 1002, '(37.56504944256021, 127.00464828401823)#(37.564573198150306, 126.99909074693937)#(37.56566175232779, 127.00385435014982)#');
