    ...
    $(document).ready(function () {
          ...
          $("#click").click(function(){
            ...
            $(document).ready(function(){
                  ...
                  socket.emit("send_msg", "server" , profile,userName+'님이 입장하셨습니다.');
                  
                     $("#msg_process").on('click', function(e){ //2
                        if($("#msg").val()!=''){
                         socket.emit("send_msg", userName , profile,$("#msg").val());
                         $('#msg').val('');
                         $('#msg').focus();
                         e.preventDefault();
                        }
                       ...
                       socket.on('receive_message', function(re ,profile, msg){ //3
                       var Now = new Date();
