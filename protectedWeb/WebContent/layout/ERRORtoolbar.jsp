...
<!--                               <input id="login_username" name="id" class="form-control" type="text" placeholder="Enter username" required> -->
<!--                               <label for="username">Password</label>  -->
<!--                               <input id="login_password" name="pw" class="form-control" type="password" placeholder="Enter password" required> -->
<!--                               <div class="checkbox"> -->
<!--                                   <label> -->
...
<!--                               <div> -->
<!--                                   <button type="submit" id="submit" class="btn btn-general btn-white">Login</button> -->
<!--                               </div> -->
<!--                               <div> -->
