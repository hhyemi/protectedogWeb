							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstname">판매자</label> <input type="text"
										...
										placeholder="상품명을 입력해주세요" value="테스트" readonly>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstname">상품명</label> <input type="text"
										...
										placeholder="상품명을 입력해주세요" value="${board.prodName}">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstname">판매가격</label> <input type="text"
										...
										placeholder="판매가격을 입력해주세요" value="${board.price}">
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="firstname"></label> <input type="text"
										class="form-control" name="postTitle" id="postTitle" value="${board.postTitle}"
								...
								<div class="col-md-13">
									<div class="form-group">
										...
										<textarea class="form-control" rows="10" name="postContent"
											placeholder="내용을 입력해주세요" value="${board.postConten}"></textarea>
									</div>
								</div>
							</div>
							</div>
