		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate text-center">
					...
					<font size="7">보호마켓 상품정보수정</font><br /> <font size="3">※판매자
						거주지는 수정할수 없습니다. 거주지 수정시 재작성 바랍니다.</font>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-xl-8 ftco-animate">
					...
					<form class="billing-form" name="addForm">
						...
						<div class="row align-items-end">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="prodName"
										id="prodName" value="${board.prodName}"
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="price" id="price"
										value=<fmt:formatNumber>${board.price}</fmt:formatNumber>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="city" id="city"
										value="${board.city}" placeholder="ex)서울시 강남구">
								</div>
							</div>
							...
							<div id="attach" class="form-group" style="width: 700px">
								<span class="label label-primary "><label
									...
									style="background-color: #f6957b; margin-left: 14px; padding: 3px; border-radius: 3px; color: #ffffff">사진등록</label></span>&nbsp;&nbsp;맨
								앞 이미지는 대표이미지입니다. (최대 <b>5장</b>까지 등록 가능합니다.) <input
							...
							<div class="form-group">
								<div class="row">
									<div id="preview" class="col-md-12" align="center"
										...
										<c:forEach var="name" items="${file}" varStatus="status">
											...
											<div class="preview-box2" value="${name.fileName}"
												style='display: inline; float: left; width: 140px'>
												<img class="thumbnail"
													src="/resources/file/fileMarket/${name.fileName}"
													width="130px;" height="115px;" /> <span href="#"
													value="${name.fileName}" onclick="deletePreview2(this)"><font
													color="#f04f23"> 삭제</font></span>
											</div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="postTitle"
										id="postTitle" placeholder="제목을 입력해주세요"
										style="width: 710px; margin-left: 17px" maxlength="12"
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="postContent" cols="20"
										style="width: 710px; margin-left: 17px" rows="11"
						...
						<input type="hidden" name="postNo" value="${board.postNo }" /> <input
							type="hidden" id="multiFile" name="multiFile" /> <input
							type="hidden" id="deleteFile" name="deleteFile" />
						<div class="col-md-12">

							<button type="button" class="btn btn-default py-3 px-4 col-md-12"
								id="addproduct">수정</button>
							<div align="right" style="margin-top: 10px">
								<p>
									<a href="#"><font color="gray" id="btn-cancel">취소</font></a>
								</p>
							</div>
						</div>
