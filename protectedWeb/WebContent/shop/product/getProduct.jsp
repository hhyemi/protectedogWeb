							...
							<c:forEach var="name" items="${file}" varStatus="status">
								...
								<div class="${className}">
									<img class="d-block w-100"
										...
										height="450px;" /> <input type="hidden"
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<div>
							...
							<ul class="list">
								<li><a class="active" href="#"> <span>카테고리 :<c:if
												test="${product.prodCode == 10}">
										사료</c:if></span> <c:if test="${product.prodCode == 20}">
										간식</c:if> <c:if test="${product.prodCode == 30}">
										의류</c:if> <c:if test="${product.prodCode == 40}">
										타임세일</c:if></a>
								<li><a href="#"> </a></li>
							</ul>
							<p>
							...
							<input type="hidden" value="${product.prodNo }" />
							<form name="addcart">
								<input type="hidden" value="${product.prodNo }" /> <input
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td id="price" data-price="${product.discountPrice}"><fmt:formatNumber
							...
							<input type="hidden" name="discountPrice"
								value="${product.discountPrice}" /><br />

							<div class="action">
								<div class="title-but">
									<button class="btn btn-general btn-white" role="button"
										id="addorder">구매하기</button>
		...
		<div class="container">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item"><a class="nav-link" id="profile-tab"
					...
					aria-controls="profile" aria-selected="false">상품 문의 <!-- Modal -->
						<!-- /.modal -->
				</a></li>
				<!--           <li class="nav-item"> -->
				<!--             <a -->
