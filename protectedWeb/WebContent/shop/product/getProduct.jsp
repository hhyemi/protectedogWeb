...
<link rel="stylesheet"
	href="../../resources/get/css/font-awesome.min.css" />
<link rel="stylesheet" href="../../resources/get/css/themify-icons.css" />
<link rel="stylesheet"
	href="../../resources/get/css/owl.carousel.min.css" />
			...
			<div class="row s_product_inner">
						...
						<div id="carouselExampleIndicators" class="carousel slide"
							...
							<ol class="carousel-indicators">
								...
								<li data-target="#carouselExampleIndicators" data-slide-to="0"
									class="active"><img
									src="resources/get/img/product/single-product/s-product-s-2.jpg"
									alt="" /></li>
								<li data-target="#carouselExampleIndicators" data-slide-to="1">
									<img
									src="resources/get/img/product/single-product/s-product-s-3.jpg"
									alt="" />
								</li>
								<li data-target="#carouselExampleIndicators" data-slide-to="2">
									<img
									src="resources/get/img/product/single-product/s-product-s-4.jpg"
									alt="" />
								</li>
							</ol>
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100"
										src="resources/get/img/product/single-product/s-product-1.jpg"
										alt="First slide" />
								</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2>${product.price} / <h2>${product.discountPrice}</h2></h2>
						<ul class="list">
						...
						<p>
							원산지 : ${product.country}<br /> 제조사 : ${product.company}<br /> 기본
							적립 포인트 : <br />
						</p>
                  ...
                  class="reduced items-count" type="button">
						...
						<div class="card_area">
							<a class="main_btn" href="#">장바구니에 담기</a> <a class="icon_btn"
	...
	<section class="product_description_area">
		<div class="container">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				aria-controls="home" aria-selected="true">상품상세정보</a></li>
				<li class="nav-item"><a class="nav-link" id="profile-tab"
					data-toggle="tab" href="#profile" role="tab"
					aria-controls="profile" aria-selected="false">상품
						문의</a></li>
				<li class="nav-item"><a class="nav-link" id="contact-tab"
					data-toggle="tab" href="#contact" role="tab"
					aria-controls="contact" aria-selected="false">구매후기</a>
				</li>
