...
<head>
	...
	//=============    검색 / page 두가지 경우 모두  Event  처리 =============
		function fncGetUserList(currentPage){
			...
			$("form").attr("method" , "POST").attr("action" , "/shop/product/listProduct?menu=${param.menu}").submit();	
		}
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">all in</a></span> <span>one</span></p>
			...
			<c:set var="i" value="${ i+1 }" />
    				<div class="row">
		    			<div class="col-sm-6 col-md-6 col-lg-4 ftco-animate">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="http://i.011st.com/ex_t/R/400x400/1/85/0/src/pd/18/4/5/4/3/5/8/GKLhE/2049454358_B.jpg" alt="Colorlib Template">
		    						<span class="status">30%</span>
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 px-3">
		    						<h3><a href="#">도비 프로페셔널 10kg 애견사료 강아지사료 개사료</a></h3>
		    						<div class="d-flex">
		    							<div class="pricing">
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="#" class="add-to-cart text-center py-2 mr-1"><span>장바구니에 담기 <i class="ion-ios-add ml-1"></i></span></a>
		    							<a href="#" class="buy-now text-center py-2">구매하기<span><i class="ion-ios-cart ml-1"></i></span></a>
		    						</p>
		    					</div>
		    				</div>
		    			</div>
		    	...
		    	<div class="sidebar-box-2">
		    			<h2 class="heading mb-2"><a href="#"></a></h2>
		    			<h2 class="heading mb-2"><a href="#">BEST</a></h2>
		    		</div>
						<div class="sidebar-box-2">
		    			<h2 class="heading mb-4"><a href="#">TIMESALE</a></h2>
		    			
		    		</div>
		    		<div class="sidebar-box-2">
		    			<h2 class="heading mb-4"><a href="#">사료</a></h2>
		    			<ul>
		    				<li><a href="#">전연령용</a></li>
		    		...
		    		<div class="sidebar-box-2">
		    			<h2 class="heading mb-4"><a href="#">간식</a></h2>
		    			<ul>
		    				<li><a href="#">소시지</a></li>
								<li><a href="#">육포</a></li>
								<li><a href="#">껌</a></li>
		    		...
		    		<div class="sidebar-box-2">
		    			<h2 class="heading mb-4"><a href="#">의류</a></h2>
		    			<ul>
		    				<li><a href="#">올인원</a></li>
		    			...
		    			<div class="sidebar-box-2">
		    			<h2 class="heading mb-4"><a href="#">중고마켓</a></h2>
		    			
		    		</div>
		    		<div class="sidebar-box-2">
		    			<h2 class="heading mb-4"><a href="#">: 관리자</a></h2>
