...
<head>
 ...
 function fncGetUserList(currentPage) {
		...
		$("form").attr("method" , "POST").attr("action" , "action","/market/listmarket&boardCode="+boardCode).submit();
	});
...
<!--  화면구성 div Start /////////////////////////////////////-->
	<div class="container">
		...
		<div class="page-header">
	       <h3 class=" text-info">중고장터 글 조회</h3>
	   	</div>
	...
	<tr>
		...
		<td align="left" data-param1="${board.id}">${purchase.buyer.userId}</td>
		<td align="left">${board.phone}</td>
