    ...
    <section class="ftco-section ftco-cart">
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(../../resources/prodmenu/images/product-3.jpg);"></div></td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(../../resources/prodmenu/images/product-4.jpg);"></div></td>
    		...
    		<div class="row justify-content-center">
    			<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
    				...
    				<p class="text-center"><a href="checkout.html" class="btn btn-primary py-3 px-4">구매하기</a></p>
    			</div>
    		</div>
			</div>
		</section>
