			...
			<div class="container" align="center">
				<table class="mdl-data-table mdl-js-data-table mdl-shadow--4dp">
					...
					<c:forEach var="product" items="${list}">
						...
						<td align="left">${order.orderNo}<input type="hidden" name="postNo" value="${order.prodNo}"/></td>
						<td align="left">${order.prodName}</td>
						<td align="left">${order.price}</td>
						<td align="left">${order.regDate}</td>
						<td align="left">${order.orderCode}</td>
					</c:forEach>
				</table>
				<!--  table end /////////////////////////////////////-->
