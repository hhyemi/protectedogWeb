...
======================================================-->        
    <header class="header">
<!--         					<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="messageViewModal" class="modal fade" style="display: none;"> -->
                ...
                <div class="mail-box">
                    <aside class="sm-side"> 
                        ...
                        <ul class="inbox-nav inbox-divider">
                            <li>
                                <a href="/message/listMessage?searchCondition=all"><i class="fa fa-envelope-o"></i> Inbox</a>
                            </li>
                            <li>
                                <a href="/message/listMessage?searchCondition=send"><i class="fa fa-envelope-o"></i> Sent Mail</a>
                            </li>
                            <li>
                                <a href="/message/listMessage?searchCondition=receive"><i class="fa fa-envelope-o"></i> Received Mail <span class="label label-danger pull-right received"></span></a>
                            </li>
<!--                             <li> -->
...
<!--                             </li> -->
	...
	function fncGetList(currentPage) {
		...
		$("form").attr("method", "POST").attr("action","/message/listReceiveMessage").submit();
	}
...
// // 					alert(sendDate);
// 					$(".modalMessageNo").text(JSONData.message.messageNo);
