...
<body>
	...
	<div class="container">
		...
		<h1 class="bg-primary text-center"> ADOPT 글 등록</h1>
		...
		<input type="hidden" name="id" value="user03" >
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
		    <label for="location" class="col-sm-offset-1 col-sm-3 control-label">위치</label>
		    <div class="col-sm-4">
		  ...
		  <div class="form-group">
		    <label for="dogDate" class="col-sm-offset-1 col-sm-3 control-label">발견실종일자</label>
		    <div class="col-sm-4">
