<%@page import="org.protectedog.service.domain.Funding"%>
...
<% Map<String,Object> map = (Map<String,Object>)request.getAttribute("map");
	List<Funding> list = (List<Funding>)map.get("list");%>

      <%for(int i=0;i<list.size();i++){%>
			<div class="col-sm-6 col-md-6 col-lg-4 ftco-animate">
                  <div class="product">
                  <%if(list.get(i).getStatusCode()=="1")%>
                  Á¶È¸ list.get(i).getVoteViewCount()
