...
<script type="text/javascript">
	$(function(){
		...
		$("button:contains('수정')").on("click",function(){
			self.location("href","/info/updateInfo.jsp");
		});
		...
		$("button:contains('삭제')").on("click",function(){
			...
			if(result){
				self.location("href","/info/delInfo");	
			}
...
<body>
	...
	<div class="container">
			...
			<div class="col-md-4" align="right" style="position : absolute; right: 0px; bottom: 0px;">조회수 : ${board.viewCount} 추천수 : ${board.recommendCount} 댓글수 : 50</div>
			</div>
			<p/>
